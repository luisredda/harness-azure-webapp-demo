...
<header>
        <nav b-4lauca5nue="" class="navbar navbar-expand-sm navbar-toggleable-sm navbar-light bg-white border-bottom box-shadow mb-3">
            <div b-4lauca5nue="" class="container-fluid">
                <a class="navbar-brand" href="http://ssh-demo.harness-demo.site/ssh-demo/index.jsp">Harness Demo - Azure Web App</a>
...
<div class="text-center">
    ...
    <p>Harness has successfully deployed your new Java application in Azure Web App!</p>
</div>
...
<table cellpadding="0" cellspacing="0" width="100%">
    ...
    <footer b-4lauca5nue="" class="border-top footer text-muted">
        <div b-4lauca5nue="" class="container">
            © 2022 - Harness Demo Web - <a href="http://ssh-demo.harness-demo.site/ssh-demo/index.jsp"></a>
        </div>
    </footer>
